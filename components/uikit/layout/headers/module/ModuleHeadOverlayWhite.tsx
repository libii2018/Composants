...
/**
 * Component allowing the addition of overlays with videos to headers
...
export default function ModuleHeadOverlayWhite({ className, children }: Props) {
  return (
    <a
      href="#"
      className={`flex flex-col items-center w-full h-full relative ${className}`}
    >
      {children}
